...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'data_table' => 'getDataTableService',
            ...
            'excelhelper' => 'getExcelhelperService',
            ...
            'ldap.security.authentication.provider' => 'getLdap_Security_Authentication_ProviderService',
            'ldap_user_provider' => 'getLdapUserProviderService',
            'locale_listener' => 'getLocaleListenerService',
            'log_activity_manager' => 'getLogActivityManagerService',
            ...
            'node_auth_helper' => 'getNodeAuthHelperService',
            'phpexcel' => 'getPhpexcelService',
            'property_accessor' => 'getPropertyAccessorService',
            'report_validator' => 'getReportValidatorService',
    ...
    /*
     * Gets the 'data_table' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Datatable A AppBundle\Services\Datatable instance
     */
    protected function getDataTableService()
    {
        return $this->services['data_table'] = new \AppBundle\Services\Datatable($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sigg', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9cefe88c348aa98815f8ac80d4701e8650dafef0978a3f450eb5bad01206b85c');
    ...
    /*
     * Gets the 'excelhelper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ExcelHelper A AppBundle\Services\ExcelHelper instance
     */
    protected function getExcelhelperService()
    {
        return $this->services['excelhelper'] = new \AppBundle\Services\ExcelHelper();
    }
    ...
    /*
     * Gets the 'ldap.security.authentication.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Authentication\Provider\LdapAuthenticationProvider A AppBundle\Security\Authentication\Provider\LdapAuthenticationProvider instance
     */
    protected function getLdap_Security_Authentication_ProviderService()
    {
        return $this->services['ldap.security.authentication.provider'] = new \AppBundle\Security\Authentication\Provider\LdapAuthenticationProvider($this->get('ldap_user_provider'), 'default', $this->get('node_auth_helper'), $this->get('doctrine.orm.default_entity_manager'), $this->get('security.encoder_factory'));
    }

    /*
     * Gets the 'ldap_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\User\LdapUserProvider A AppBundle\Security\User\LdapUserProvider instance
     */
    protected function getLdapUserProviderService()
    {
        return $this->services['ldap_user_provider'] = new \AppBundle\Security\User\LdapUserProvider($this->get('doctrine.orm.default_entity_manager'), $this->get('node_auth_helper'));
    }
    ...
    /*
     * Gets the 'log_activity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\LogActivityManager A AppBundle\Services\LogActivityManager instance
     */
    protected function getLogActivityManagerService()
    {
        return $this->services['log_activity_manager'] = new \AppBundle\Services\LogActivityManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }
    ...
    /*
     * Gets the 'node_auth_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Authentication\Node\AuthHelper A AppBundle\Security\Authentication\Node\AuthHelper instance
     */
    protected function getNodeAuthHelperService()
    {
        return $this->services['node_auth_helper'] = new \AppBundle\Security\Authentication\Node\AuthHelper($this->get('circle.restclient'), 'http://23.20.75.28:3000');
    }
    ...
    /*
     * Gets the 'report_validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\ReportValidator A AppBundle\Services\ReportValidator instance
     */
    protected function getReportValidatorService()
    {
        return $this->services['report_validator'] = new \AppBundle\Services\ReportValidator($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $k->add($j, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
        ...
        $o->setProviderKey('default');

        $p = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $l, array(), $a);
        ...
        $r = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $l, array(), $a);
        $r->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $s = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/login', false);

        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('ldap_user_provider')), 'default', $a, $c), 2 => $m, 3 => new \AppBundle\Security\Firewall\LdapListener($b, $f, $n, $l, 'default', $o, $p, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $n, $l, 'default', $q, $r, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 5 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $f, 'default', $s, $a), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '59400c43141415.73343808', $a, $f), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'default', $s, NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('gdgestarsalud@gmail.com');
        $a->setPassword('Gestar2015*');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('public_socket_io', 'http://localhost:3131');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => $this->get('ldap.security.authentication.provider'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('ldap_user_provider'), $this->get('security.user_checker.default'), 'default', $this->get('security.encoder_factory'), true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59400c43141415.73343808')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'gdgestarsalud@gmail.com',
            'mailer_password' => 'Gestar2015*',
            'mail_sender' => 'GDgestar@gmail.com',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'ahelper_host' => 'http://23.20.75.28:3000',
            'files_path' => ($this->targetDirs[4].'/'),
            'engine_path' => 'http://localhost:3030',
            'public_socket_io' => 'http://localhost:3131',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'gdgestarsalud@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Gestar2015*',
